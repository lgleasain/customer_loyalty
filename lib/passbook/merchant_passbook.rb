  ...
  class MerchantPassbook
    ...
    def initialize customer_id, merchant_id, loyalty_url
      ...
      @pass = {'logoText' => '', 
        ...
        'primaryFields' => [{
        'key' => 'name',
        'label' => merchant.reward_program_name ? merchant.reward_program_name : '',
        'value' => customer.user.name ? customer.user.name : '' }],
        'backFields' => [{
          'key' => 'reward',
          'label' => 'Your Reward',
          'value' => merchant.reward_description ? merchant.reward_description : '' }],
        'secondaryFields' => [{
        'key' => 'donuts',
        'label' => merchant.earn_type ? merchant.earn_type : '' ,
        'value' => @customer_passbook.balance ? @customer_passbook.balance : '' },
        {'key' => 'secondary_3',
